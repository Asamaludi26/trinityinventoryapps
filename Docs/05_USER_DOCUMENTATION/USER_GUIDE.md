...
Selamat datang di Panduan Pengguna Aplikasi Inventori Aset PT. Trinity Media Indonesia. Dokumen ini bertujuan untuk membantu Anda memahami dan menggunakan fitur-fitur aplikasi secara efektif sesuai dengan peran Anda.
...
1.  Buka halaman **Pusat Aset > Request Aset**, lalu klik tab **Request Pinjam** di bagian atas (atau menu _Request Pinjam_ di sidebar).
