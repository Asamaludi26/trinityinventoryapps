      ...
      >
        ...
        <section>
          ...
          <dl className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2 text-sm">
            <div>
              <dt className="font-medium text-gray-500">Tanggal Instalasi</dt>
            ...
            <div>
              <dt className="font-medium text-gray-500">Teknisi Pelaksana</dt>
              <dd className="font-semibold text-gray-900">
                {installation.technician}
              </dd>
            </div>
            <div>
              <dt className="font-medium text-gray-500">Dibuat Oleh</dt>
              <dd className="font-semibold text-gray-900">
        ...
        <section>
          ...
          <dl className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2 text-sm">
            <div>
              <dt className="font-medium text-gray-500">Nama Pelanggan</dt>
              <dd className="font-semibold text-gray-900">
                {customer ? (
                  <ClickableLink
                    onClick={() =>
            ...
            <div>
              <dt className="font-medium text-gray-500">ID Pelanggan</dt>
            ...
            {customer && (
              <>
                ...
                <div>
                  <dt className="font-medium text-gray-500">Kontak</dt>
              ...
              <tbody>
                ...
                {installation.assetsInstalled.length === 0 && (
                  <tr>
                    ...
                    >
                      Tidak ada perangkat utama yang dipasang.
                    </td>
                  </tr>
                )}
              </tbody>
          ...
          <div className="grid grid-cols-1 text-sm text-center gap-y-6 sm:grid-cols-3">
            <div>
              ...
              <div className="flex items-center justify-center mt-2 h-28">
                <SignatureStamp
                  signerName={installation.technician}
                  signatureDate={installation.installationDate}
                  signerDivision={getDivisionForUser(installation.technician)}
                />
              </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-center mt-2 h-28">
                {installation.acknowledger ? (
                  <SignatureStamp
                    signerName={installation.acknowledger}
                    signatureDate={installation.installationDate}
