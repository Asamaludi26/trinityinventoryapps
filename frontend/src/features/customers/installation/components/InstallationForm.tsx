        ...
        .map((mat, index): MaterialItemState | null => {
          ...
          if (!option) {
            option = materialOptions.find(
              (opt) =>
                opt.label.includes(mat.name) && opt.label.includes(mat.brand),
            );
          }
      ...
      <form id={formId} onSubmit={handleSubmit} className="space-y-6">
        ...
        <section className="p-4 border-t border-b">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">
                Teknisi Pelaksana <span className="text-red-500">*</span>
              </label>
              <CustomSelect
              ...
              {technician && (
                <p className="text-xs text-blue-600 mt-1">
                  Stok akan diambil dari inventaris {technician}.
                </p>
              )}
            </div>
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="block w-full px-3 py-2 text-gray-900 bg-white border border-gray-300 rounded-md shadow-sm sm:text-sm focus:ring-primary-500 focus:border-primary-500"
            ...
            <div className="p-5 border border-blue-200 rounded-xl bg-blue-50/40 shadow-sm">
              ...
              <div className="mb-4">
                <CustomSelect
                  ...
                  placeholder="Tambah perangkat dari gudang/teknisi..."
                  isSearchable
                />
              </div>
              ...
              {assetsInstalled.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {assetsInstalled.map((asset) => (
                    <div
                      key={asset.assetId}
                      className="flex flex-col p-3 bg-white border border-gray-200 rounded-lg shadow-sm relative group"
                    >
            ...
            <div className="p-5 border border-orange-200 rounded-xl bg-orange-50/40 shadow-sm">
              ...
              <div className="space-y-3">
                {materialsUsed.map((material, index) => (
                  <div
                    key={material.id}
                    className="grid grid-cols-12 gap-3 p-3 bg-white border border-gray-200 rounded-lg shadow-sm items-center"
                  >
                    {/* Material Selection */}
                    <div className="col-span-12 sm:col-span-5">
                      ...
                      {material.materialAssetId && (
                        <div className="mt-1 text-[10px] font-mono text-blue-600 flex items-center gap-1 bg-blue-50 w-fit px-1.5 py-0.5 rounded border border-blue-100">
                          <ArchiveBoxIcon className="w-3 h-3" /> Sumber:{" "}
                          {material.materialAssetId}
                        </div>
                      )}
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="0"
                        />
                        <span className="absolute inset-y-0 right-0 flex items-center pr-3 text-xs text-gray-500 pointer-events-none font-bold bg-gray-100 h-full rounded-r-lg border-l px-2">
                          {material.unit}
                        </span>
                      </div>
                    </div>
                        ...
                        className={`w-full h-[38px] mt-auto px-2 text-xs font-bold rounded-lg border flex items-center justify-center gap-2 transition-colors
                                                    ${
                                                      material.materialAssetId
                                                        ...
                                                        : "bg-white text-gray-600 border-gray-300 hover:bg-gray-50 hover:text-primary-600"
                                                    } ${!material.modelKey ? "opacity-50 cursor-not-allowed" : ""}`}
                        title={
                          material.materialAssetId
                            ? `Terpilih: ${material.materialAssetId}`
                            : "Pilih sumber stok spesifik"
                        }
                      >
                    ...
                    <div className="col-span-2 sm:col-span-1 flex items-end justify-end">
                      <button
                        ...
                        className="w-9 h-[38px] mt-auto flex items-center justify-center text-gray-400 bg-gray-50 border border-gray-200 rounded-lg hover:bg-red-50 hover:text-red-500 hover:border-red-200 transition-colors"
                      >
                        <TrashIcon className="w-4 h-4" />
                      </button>
                    </div>
              ...
              <button
                ...
                className="mt-4 w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-bold text-orange-700 bg-orange-100 border border-orange-200 rounded-lg hover:bg-orange-200 transition-colors"
              >
        ...
        <section className="p-4 border-t border-b border-gray-200">
          ...
          <div>
            ...
            <textarea
              ...
              className="block w-full px-3 py-2 mt-1 text-gray-900 placeholder:text-gray-400 bg-gray-50 border border-gray-300 rounded-md shadow-sm"
              placeholder="Contoh: Posisi router di ruang tamu..."
            />
          </div>
