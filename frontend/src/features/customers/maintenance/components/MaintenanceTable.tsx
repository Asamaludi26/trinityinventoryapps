            ...
            >
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-xs text-gray-500">
                  {new Date(m.maintenanceDate).toLocaleDateString("id-ID", {
                    day: "numeric",
                    month: "short",
                    year: "numeric",
                  })}
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                ...
                <div
                  ...
                  title={(m.assets || []).map((a) => a.assetName).join(", ")}
                >
              ...
              <td className="px-6 py-4 text-sm font-medium text-right">
                <button className="p-2 text-slate-400 rounded-full hover:bg-blue-50 hover:text-primary-600 transition-colors">
            ...
            <td colSpan={6} className="px-6 py-12 text-center text-gray-500">
              <div className="flex flex-col items-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Ubah filter atau buat laporan baru.
                </p>
              </div>
            </td>
          </tr>
