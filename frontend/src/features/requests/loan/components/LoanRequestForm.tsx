...
import { User, Asset, Division, LoanItem } from "../../../../types";
      ...
      await onSave({
        loanItems: loanItems.map((item) => {
          ...
          return {
            ...
            returnDate: item.isIndefinite
              ? null
              : item.returnDate?.toISOString().split("T")[0] || null,
          };
        }),
        notes,
      });
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-4 md:grid-cols-2 text-sm">
          <div>
            ...
            <input
              ...
              className="w-full p-2 mt-1 bg-gray-100 border border-gray-200 rounded-md text-gray-600"
            />
          </div>
          <div>
        ...
        <section className="pt-4 border-t">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-semibold text-white transition-colors bg-primary-500 rounded-lg shadow-sm hover:bg-primary-600"
            >
              Tambah Aset
            </button>
          </div>
            ...
            <div className="p-4 border rounded-lg bg-blue-50/30 border-blue-200/80 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-end pb-1">
                  <label
                    ...
                    className="flex items-center space-x-3 cursor-pointer text-sm text-gray-700"
                  >
                    <Checkbox
              ...
              <div className="mt-4 flex justify-end">
                <button
                  ...
                  className="px-4 py-2 text-sm font-semibold text-white bg-primary-600 rounded-lg shadow-sm hover:bg-primary-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
          ...
          <div className="space-y-6">
            {loanItems.map((item, index) => {
              ...
              return (
                <div
                  key={item.tempId}
                  className={`relative p-5 pt-6 bg-white border rounded-xl shadow-sm transition-all duration-300 ${selectedItemIds.includes(item.tempId) ? "border-primary-600 ring-2 ring-primary-500/30" : "border-gray-200/80"}`}
                >
                  <div className="absolute flex items-center justify-center w-8 h-8 font-bold text-white rounded-full -top-4 left-4 bg-primary-600 shadow-lg">
                    {index + 1}
                  </div>
                  ...
                  {loanItems.length > 1 && (
                    <button
                      ...
                      className="absolute top-3 right-3 flex items-center justify-center w-8 h-8 text-gray-400 transition-colors rounded-full hover:bg-red-100 hover:text-red-500 z-10"
                  ...
                  {loanItems.length > 1 && (
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <label
                        ...
                        className="text-sm font-medium text-gray-700 cursor-pointer"
                      >
                        Pilih item ini untuk aksi massal
                      </label>
                    </div>
                  )}
