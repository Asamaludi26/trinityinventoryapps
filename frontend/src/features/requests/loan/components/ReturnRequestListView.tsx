...
export const ReturnRequestListView: React.FC<ReturnRequestListViewProps> = ({
  ...
  const filteredReturns = useMemo(() => {
    ...
    if (!["Admin Logistik", "Super Admin"].includes(currentUser.role)) {
      tempReturns = tempReturns.filter(
        (ret) => ret.returnedBy === currentUser.name,
      );
    }
    ...
    return tempReturns
      .filter((ret) => {
        ...
        return (
          ret.docNumber.toLowerCase().includes(searchLower) ||
          ret.items.some((i) =>
            i.assetName.toLowerCase().includes(searchLower),
          ) ||
  ...
  const {
    ...
    requestSort,
    sortConfig,
  } = useSortableData(filteredReturns, {
    key: "returnDate",
      ...
      <div className="p-4 mb-4 bg-white border border-gray-200/80 rounded-xl shadow-md space-y-4">
        <div className="flex flex-wrap items-center gap-4">
          <div className="relative flex-grow">
            ...
            <input
              type="text"
              placeholder="Cari No. Dokumen, Aset, Pengguna..."
              value={searchQuery}
                    ...
                    <div>
                      ...
                      <CustomSelect
                        options={[
                          ...
                          ...Object.values(AssetReturnStatus).map((s) => ({
                            value: s,
                            label: s,
                          })),
                        ]}
