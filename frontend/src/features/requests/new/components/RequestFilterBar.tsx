      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="relative flex-grow">
          ...
          <input
            ...
            className="w-full h-10 py-2 pl-10 pr-4 text-sm font-medium text-slate-700 bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary-50 focus:border-primary-600 transition-all outline-none placeholder:text-slate-400"
          />
        </div>
          ...
          {isFilterPanelOpen && (
            <>
              <div
                ...
                className="fixed inset-0 z-20 bg-slate-900/20 backdrop-blur-sm sm:hidden"
              />
              <div className="fixed top-20 left-4 right-4 z-30 flex flex-col bg-white border border-slate-200 rounded-xl shadow-2xl sm:absolute sm:top-full sm:left-auto sm:right-0 sm:mt-2 sm:w-80 animate-zoom-in">
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
                  ...
                  <button
                    onClick={() => setIsFilterPanelOpen(false)}
                    className="p-1 text-slate-400 rounded-full hover:bg-slate-100 hover:text-slate-600 transition-colors"
                  >
                  ...
                  <div>
                    ...
                    <CustomSelect
                      options={[
                        ...
                        { value: "Regular Stock", label: "Regular Stock" },
                ...
                <div className="flex items-center justify-between px-5 py-4 bg-slate-50 border-t border-slate-100 rounded-b-xl">
                  ...
                  <button
                    onClick={handleApply}
                    className="px-6 py-2 text-xs font-bold text-white bg-primary-600 rounded-lg shadow-md hover:bg-primary-700 transition-all transform active:scale-95"
                  >
                    Terapkan
                  </button>
                </div>
        ...
        <div className="flex flex-wrap gap-2 animate-fade-in-down">
          {filters.status && (
            <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-bold text-blue-700 bg-blue-50 border border-blue-100 rounded-full shadow-sm">
              ...
              <button
                onClick={() => handleRemoveOne("status")}
                className="p-0.5 ml-1 rounded-full hover:bg-blue-200 text-blue-500 transition-colors"
              >
          ...
          {filters.orderType && (
            <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-bold text-purple-700 bg-purple-50 border border-purple-100 rounded-full shadow-sm">
              ...
              <button
                onClick={() => handleRemoveOne("orderType")}
                className="p-0.5 ml-1 rounded-full hover:bg-purple-200 text-purple-500 transition-colors"
              >
                <CloseIcon className="w-3 h-3" />
              </button>
            </span>
          ...
          {filters.division && (
            <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-bold text-orange-700 bg-orange-50 border border-orange-100 rounded-full shadow-sm">
              ...
              <button
                onClick={() => handleRemoveOne("division")}
                className="p-0.5 ml-1 rounded-full hover:bg-orange-200 text-orange-500 transition-colors"
              >
                <CloseIcon className="w-3 h-3" />
              </button>
            </span>
          ...
          {(filters.startDate || filters.endDate) && (
            <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-100 rounded-full shadow-sm">
              ...
              <button
                ...
                className="p-0.5 ml-1 rounded-full hover:bg-emerald-200 text-emerald-500 transition-colors"
              >
                <CloseIcon className="w-3 h-3" />
              </button>
            </span>
          ...
          <button
            onClick={handleReset}
            className="px-3 py-1 text-xs font-bold text-slate-500 hover:text-red-600 hover:bg-red-50 rounded-full transition-colors"
          >
            Hapus Semua
          </button>
        </div>
