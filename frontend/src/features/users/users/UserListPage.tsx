...
import { User, UserRole, Page, PreviewData, Division } from '../../../types';
...
export const UserListPage: React.FC<UserListPageProps> = ({ currentUser, setActivePage }) => {
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [itemsPerPage, userSearchQuery, userFilters]);
    ...
    return (
        <div className="p-4 sm:p-6 md:p-8">
            <div className="flex flex-col items-start justify-between gap-4 mb-6 md:flex-row md:items-center">
                <h1 className="text-3xl font-bold text-tm-dark">Manajemen Akun</h1>
                <div className="flex items-center space-x-2">
                    ...
                    {hasPermission(currentUser, 'users:create') && (
                        <button
                            onClick={() => setActivePage('user-form')}
                ...
                <div className="p-4 mb-4 bg-blue-50 border-l-4 border-tm-accent rounded-r-lg">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <button onClick={() => {/* TODO: Implement bulk delete */}} className="px-3 py-1.5 text-sm font-semibold text-red-600 bg-red-100 rounded-md hover:bg-red-200">Hapus</button>
                        </div>
            ...
            {userToDelete && <Modal isOpen={!!userToDelete} onClose={() => setUserToDelete(null)} title="Konfirmasi Hapus Akun" size="md">
                ...
                <div className="flex justify-end gap-2 mt-6 pt-4 border-t">
                    <button onClick={() => setUserToDelete(null)} className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50">Batal</button>
                    <button onClick={handleDeleteUser} disabled={isLoading} className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-danger rounded-lg shadow-sm hover:bg-red-700">
