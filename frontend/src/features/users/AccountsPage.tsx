  ...
  return (
    <div className="p-4 sm:p-6 md:p-8">
      <div className="flex flex-col items-start justify-between gap-4 mb-6 md:flex-row md:items-center">
        <h1 className="text-3xl font-bold text-gray-900">Akun & Divisi</h1>
      ...
      <div className="mb-6 border-b border-gray-200">
        <nav className="flex -mb-px space-x-6" aria-label="Tabs">
          <button
            ...
            className={`py-3 px-1 border-b-2 font-medium text-sm ${activeView === "users" ? "border-primary-600 text-primary-600" : "border-transparent text-gray-500 hover:text-gray-700"}`}
          >
            Manajemen Akun ({sortedUsers.length})
          </button>
          <button
            onClick={() => setActiveView("divisions")}
            className={`py-3 px-1 border-b-2 font-medium text-sm ${activeView === "divisions" ? "border-primary-600 text-primary-600" : "border-transparent text-gray-500 hover:text-gray-700"}`}
          >
              ...
              <div className="relative" ref={filterPanelRef}>
                ...
                >
                  ...
                  {activeUserFilterCount > 0 && (
                    <span className="px-2 py-0.5 text-xs font-bold text-white rounded-full bg-primary-600">
                      {activeUserFilterCount}
                    </span>
                  )}
                </button>
          ...
          <div className="overflow-hidden bg-white border border-gray-200/80 rounded-xl shadow-md">
            <div className="overflow-x-auto custom-scrollbar">
              <UsersTable
                ...
                onEdit={(user) =>
                  setActivePage("user-form", { editingUser: user })
                }
                onDelete={(user) => setUserToDelete(user)}
                onDetail={(user) =>
                  setActivePage("user-detail", { userId: user.id })
                }
          ...
          <div className="overflow-hidden bg-white border border-gray-200/80 rounded-xl shadow-md">
            <div className="overflow-x-auto custom-scrollbar">
              <DivisionsTable
                ...
                onEdit={(division) =>
                  setActivePage("division-form", { editingDivision: division })
                }
      ...
      {userToDelete && (
        ...
        >
          <p className="text-sm text-gray-600">
            Anda yakin ingin menghapus akun <strong>{userToDelete.name}</strong>
      ...
      {divisionToDelete && (
        ...
        >
          <p className="text-sm text-gray-600">
            ...
            <strong>{divisionToDelete.name}</strong>? Aksi ini tidak dapat
            diurungkan.
          </p>
          <div className="flex justify-end gap-2 mt-6 pt-4 border-t">
            <button
