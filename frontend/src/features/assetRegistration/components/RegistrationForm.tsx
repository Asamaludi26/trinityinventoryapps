  ...
  const ActionButtons = () => (
    <>
      ...
      <button
        ...
        className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-semibold text-white transition-all duration-200 rounded-lg shadow-sm bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:bg-primary-600/70 disabled:cursor-not-allowed"
      >
  ...
  return (
    <>
      <form id={formId} className="space-y-8" onSubmit={onSubmitWrapper}>
        {prefillData && (
          <div className="p-4 border-l-4 rounded-r-lg bg-info-light border-primary-600">
        ...
        <div className="p-4 border-t border-b border-gray-200">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <DatePicker
                id="regDate"
                selectedDate={new Date(formData.registrationDate)}
                onDateChange={(d) =>
                  updateField(
                    "registrationDate",
            ...
            {formData.relatedRequestDocNumber && (
              <div>
                ...
                <input
                  type="text"
                  readOnly
                  className="block w-full px-3 py-2 mt-1 text-blue-800 bg-blue-50 border border-blue-200 rounded-md shadow-sm sm:text-sm font-mono"
                  value={formData.relatedRequestDocNumber}
                />
              </div>
            )}
          </div>
        ...
        <FinancialSection
          ...
          setWarrantyDate={handleWarrantyDateChange}
