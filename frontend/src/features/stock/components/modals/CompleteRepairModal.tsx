      ...
      footerContent={
        <>
          ...
          <button
            ...
            disabled={isLoading}
            className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-success rounded-lg shadow-sm hover:bg-green-700 disabled:bg-green-300"
          >
    ...
    >
      <div className="space-y-6">
        <p className="text-sm text-gray-600">
          Aset akan dikembalikan ke status "Digunakan". Harap isi detail
        ...
        <div>
          ...
          <div className="mt-1">
            <CustomSelect
              ...
              value={newCondition}
              onChange={(v) => setNewCondition(v as AssetCondition)}
            />
          </div>
        </div>
        <div>
          <label
            htmlFor="actions-taken"
            className="block text-sm font-medium text-gray-700"
          >
            Tindakan yang Diambil (pisahkan dengan koma)
          </label>
          <textarea
            id="actions-taken"
            rows={2}
