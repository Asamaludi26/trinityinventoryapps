...
export const CriticalStockPanel: React.FC<CriticalStockPanelProps> = ({
  items,
  onRestock,
}) => {
      ...
      <div className="flex flex-col items-center justify-center text-center text-gray-400 space-y-3 py-12 bg-gray-50/50 rounded-xl border border-dashed border-gray-200">
        ...
        <div>
          ...
          <p className="text-xs mt-1 text-gray-500">
            Tidak ada item yang habis (0 stok) saat ini.
          </p>
        </div>
      </div>
    );
    ...
    <div className="flex flex-col h-full">
      <div className="flex justify-end mb-4">
        <button
          ...
          className="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-white bg-primary-600 hover:bg-primary-700 rounded-lg transition-all shadow-sm hover:shadow-md active:scale-95"
        >
