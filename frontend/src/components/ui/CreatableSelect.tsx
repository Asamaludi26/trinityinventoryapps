    ...
    <div className="relative w-full" ref={wrapperRef}>
      <div className="relative">
        <input
          ...
          disabled={disabled}
          className={`w-full px-3 py-2 text-left bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary-500 sm:text-sm ${disabled ? "bg-gray-200/60 text-gray-500 cursor-not-allowed" : "text-gray-900"}`}
          autoComplete="off"
        />
        ...
        <ul>
          {showCreateOption && (
            <li
              ...
              className="flex items-center gap-2 px-3 py-2.5 text-sm cursor-pointer transition-colors duration-150 text-primary-600 bg-primary-50 hover:bg-primary-100"
            >
