    ...
    types: [
      {
        ...
        unitOfMeasure: "unit",
        standardItems: [
          { id: 1, name: "Router Core RB4011iGS+", brand: "Mikrotik" },
          { id: 2, name: "CCR1009-7G-1C-1S+", brand: "Mikrotik" },
        ],
      },
      {
        id: 2,
        ...
        unitOfMeasure: "unit",
        standardItems: [
          { id: 3, name: "Switch CRS326-24G-2S+", brand: "Mikrotik" },
        ],
      },
      {
        id: 3,
        ...
        unitOfMeasure: "unit",
        standardItems: [
          { id: 4, name: "OLT Hioso 4 Port", brand: "Hioso" },
          { id: 5, name: "OLT ZTE C320", brand: "ZTE" },
        ],
      },
    ],
  },
    ...
    types: [
      {
        ...
        standardItems: [
          { id: 11, name: "Dropcore 1 Core (Hasbal)", brand: "FiberHome" },
        ],
      },
      {
        id: 7,
    ...
    types: [
      {
        ...
        unitOfMeasure: "unit",
        standardItems: [
          { id: 17, name: "Fusion Splicer 90S", brand: "Fujikura" },
          { id: 18, name: "Fusion Splicer AI-9", brand: "Signal Fire" },
        ],
      },
      {
        id: 11,
  ...
  },
  {
    ...
    types: [
      ...
      },
      {
        ...
        unitOfMeasure: "unit",
        standardItems: [
          { id: 21, name: "ThinkPad X1 Carbon", brand: "Lenovo" },
          { id: 22, name: "MacBook Air M1", brand: "Apple" },
        ],
      },
    ],
  },
...
export const mockCustomers: Customer[] = [
  {
    id: "TMI-CUST-001",
    name: "Budi Santoso (Home)",
    address: "Jl. Meruya Ilir No. 45, Jakarta Barat",
    phone: "+62-812-5555-001",
    email: "budi.santoso@gmail.com",
    status: CustomerStatus.ACTIVE,
    installationDate: d(-120),
    servicePackage: "Home 50Mbps",
    activityLog: [],
  },
  {
    id: "TMI-CUST-002",
    name: "PT. Maju Mundur (Corp)",
    address: "Gedung Cyber Lt. 8, Kuningan, Jakarta Selatan",
    phone: "+62-21-520-9999",
    email: "it@majumundur.co.id",
    status: CustomerStatus.ACTIVE,
    installationDate: d(-90),
    servicePackage: "Dedicated 200Mbps",
    activityLog: [],
  },
  {
    id: "TMI-CUST-003",
    ...
    email: "manager@kopisenja.com",
    status: CustomerStatus.SUSPENDED,
    installationDate: d(-30),
    servicePackage: "SOHO 100Mbps",
    activityLog: [],
  },
];
...
export const mockAssets: Asset[] = [
  ...
  {
    id: "NET-001",
    name: "Router Core RB4011iGS+",
    category: "Perangkat Jaringan (Core)",
    type: "Router Core",
    brand: "Mikrotik",
    serialNumber: "MT-CORE-001",
    registrationDate: d(-365),
    recordedBy: "Admin Logistik User",
    purchaseDate: d(-365),
    purchasePrice: 5000000,
    vendor: "Citra Web",
    location: "Rack Server HQ",
    currentUser: "Leader User",
  ...
  // CPE - In Use (Customer)
  {
    ...
    type: "ONT/ONU",
    brand: "Huawei",
    serialNumber: "HW-ONT-001",
    registrationDate: d(-120),
    recordedBy: "Admin Logistik User",
    purchaseDate: d(-125),
    purchasePrice: 750000,
    vendor: "Optik Prima",
    location: "Terpasang di Pelanggan",
    currentUser: "TMI-CUST-001",
    status: AssetStatus.IN_USE,
    condition: AssetCondition.GOOD,
    activityLog: [],
    attachments: [],
    ...
    warrantyEndDate: d(240),
    notes: "Installed at Budi Home",
  },
  {
    id: "CPE-002",
    name: "ONT F609",
    ...
    type: "ONT/ONU",
    brand: "ZTE",
    serialNumber: "ZT-ONT-002",
    registrationDate: d(-90),
    recordedBy: "Admin Logistik User",
    purchaseDate: d(-95),
    purchasePrice: 700000,
    vendor: "Optik Prima",
    location: "Terpasang di Pelanggan",
    currentUser: "TMI-CUST-002",
    status: AssetStatus.IN_USE,
    condition: AssetCondition.GOOD,
    activityLog: [],
    attachments: [],
    ...
    warrantyEndDate: d(270),
    notes: "Installed at Maju Mundur",
  },
  ...
  // CPE - In Storage
  {
    ...
    type: "ONT/ONU",
    brand: "Huawei",
    serialNumber: "HW-ONT-003",
    registrationDate: d(-20),
    recordedBy: "Admin Logistik User",
    purchaseDate: d(-20),
    purchasePrice: 750000,
    vendor: "Optik Prima",
    ...
    activityLog: [],
    attachments: [],
    poNumber: "REQ-INIT-02",
    invoiceNumber: "INV-100",
    warrantyEndDate: d(340),
    notes: "Stok baru",
  },
  {
    id: "CPE-004",
    ...
    type: "Router WiFi",
    brand: "TP-Link",
    serialNumber: "TP-WR-004",
    registrationDate: d(-15),
    recordedBy: "Admin Logistik User",
    purchaseDate: d(-15),
    ...
    activityLog: [],
    attachments: [],
    poNumber: "REQ-INIT-03",
    invoiceNumber: "INV-101",
    warrantyEndDate: d(350),
    notes: null,
  },
  ...
  // OFFICE - In Use
  {
    ...
    type: "Laptop",
    brand: "Apple",
    serialNumber: "FVFG-M1-001",
    registrationDate: d(-60),
    recordedBy: "Admin Logistik User",
    purchaseDate: d(-60),
    purchasePrice: 14000000,
    vendor: "iBox",
    location: "Kantor Management",
    currentUser: "Super Admin User",
    status: AssetStatus.IN_USE,
    condition: AssetCondition.GOOD,
    activityLog: [],
    attachments: [],
    poNumber: "PO-OFC-01",
    invoiceNumber: null,
    warrantyEndDate: d(300),
    notes: "Laptop Direktur",
  },
  ...
  ...generateBulkItems(
    20,
    "Patchcord SC-UPC 3m",
    "Infrastruktur Fiber Optik (Material)",
    "Aksesoris Koneksi",
    "Generic",
    "MAT-PC"
  ),
...
export const initialMockRequests: Request[] = [
  // 1. Pending Request (Regular) - Staff to Leader/Admin
  {
    ...
    items: [
      {
        id: 1,
        itemName: "Router WR840N",
        itemTypeBrand: "TP-Link",
        quantity: 5,
        keterangan: "Stok teknisi lapangan menipis",
        stock: 1,
        categoryId: "2",
        typeId: "5",
      },
  ...
  // 2. Logistic Approved (Urgent) - Waiting for Purchase
  {
    ...
    order: {
      type: "Urgent",
      justification:
        "Penggantian Switch Core yang mati total di POP Cempaka Putih",
    },
    items: [
      {
        id: 1,
        itemName: "Switch CRS326-24G-2S+",
        itemTypeBrand: "Mikrotik",
        quantity: 1,
        keterangan: "Urgent replacement",
        stock: 0,
        categoryId: "1",
        typeId: "2",
      },
    ...
    activityLog: [
      {
        ...
        timestamp: d(-3),
        type: "comment",
        payload: { text: "Mohon diproses segera" },
      },
    ],
  },
  // 3. Arrived (Ready for Registration)
  {
    ...
    items: [
      {
        id: 1,
        itemName: "ONT HG8245H",
        itemTypeBrand: "Huawei",
        quantity: 10,
    ...
    purchaseDetails: {
      1: {
        ...
        vendor: "Optik Prima",
        poNumber: "PO-OCT-001",
        invoiceNumber: "INV-OCT-001",
        purchaseDate: d(-5),
        warrantyEndDate: d(360),
        filledBy: "Admin Purchase User",
        fillDate: d(-4),
      },
    },
    totalValue: 7500000,
  ...
  // 4. Completed (History)
  {
    ...
    items: [
      {
        id: 1,
        itemName: "Tang Krimping",
        itemTypeBrand: "Krisbow",
        quantity: 2,
        keterangan: "Untuk teknisi baru",
        stock: 0,
        categoryId: "5",
        typeId: "11",
      },
...
export const mockLoanRequests: LoanRequest[] = [
    ...
    items: [
      {
        ...
        brand: "Fujikura",
        quantity: 1,
        keterangan: "Peminjaman untuk project instalasi Apartemen",
        returnDate: d(5),
      },
    ],
  ...
  // 2. Overdue Loan (Testing Alert)
  {
    ...
    items: [
      {
        id: 1,
        itemName: "Optical Power Meter (OPM)",
        brand: "Joinwit",
        quantity: 1,
        keterangan: "Maintenance link",
        returnDate: d(-1),
      },
    ],
    approver: "Admin Logistik User",
    ...
    items: [
      {
        ...
        itemTypeBrand: "Apple",
        conditionNotes: "Baru, segel dibuka untuk pengecekan",
        quantity: 1,
        checked: true,
      },
    ],
...
export const mockInstallations: Installation[] = [
  {
    ...
    assetsInstalled: [
      {
        assetId: "CPE-001",
        assetName: "ONT HG8245H",
        serialNumber: "HW-ONT-001",
      },
    ],
    materialsUsed: [
      {
        itemName: "Dropcore 1 Core (Hasbal)",
        brand: "FiberHome",
        quantity: 150,
        unit: "Meter",
      },
      {
        itemName: "Fast Connector SC-UPC",
        brand: "Generic",
        quantity: 2,
        unit: "Pcs",
      },
...
export const mockReturns: AssetReturn[] = [
  ...
  },
  {
    ...
    rejectionDate: d(-9),
    rejectionReason:
      "Kondisi dilaporkan rusak ringan, namun fisik retak parah. Perlu investigasi.",
  },
];
